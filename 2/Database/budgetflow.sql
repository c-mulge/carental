...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Feb 07, 2025 at 03:36 PM
...
ALTER TABLE `subscription`
  ...
  ADD CONSTRAINT `subscription_ibfk_2` FOREIGN KEY (`plan_id`) REFERENCES `pricing` (`plan_id`) ON DELETE CASCADE ON UPDATE CASCADE;
